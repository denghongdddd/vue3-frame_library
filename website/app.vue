...
import enLocale from 'element-plus/packages/locale/lang/en'
import esLocale from 'element-plus/packages/locale/lang/es'
import frLocale from 'element-plus/packages/locale/lang/fr'
import jaLocale from 'element-plus/packages/locale/lang/ja'
